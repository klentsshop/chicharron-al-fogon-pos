...
import { createImageUrlBuilder } from '@sanity/image-url'; // ✅ Cambio: Usamos la exportación nombrada
...
const builder = createImageUrlBuilder(client); // ✅ Cambio: Usamos el nuevo constructor
